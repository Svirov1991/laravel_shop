                    ...
                    {{-- <div class="panel"> --}}
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                @endphp
                                <select class="form-control select2" id="wholesaler" name="wholesaler">
                                    <option value="NONE" {{ (null == $selected_wholesaler ? 'selected' : '') }}>None</option>
                                    <option value="REQUEST" {{ ('REQUEST' == $selected_wholesaler ? 'selected' : '') }}>REQUEST</option>
                                    <option value="WHOLESALER" {{ ('WHOLESALER' == $selected_wholesaler ? 'selected' : '') }}>WHOLESALER</option>
                                </select>
                            </div>
