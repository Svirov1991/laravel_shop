                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            @php
                                ...
                                $cart = $dataTypeRows->where('field', 'cart')->first();
                                $products = $dataTypeContent->getProducts();
                                $exclude = [ 'cart', 'office_code', 'settlement_code' ];
                            @endphp
            ...
            <div class="col-md-4">
                ...
                <div class="panel panel panel-bordered panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="icon wb-clipboard"></i> Заказ</h3>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        @if( !empty( $product->cart->attributes_html ) && is_array( $product->cart->attributes_html ) )
                                            ...
                                            @endforeach
                                        @else
                                            {{ __('messages.without_attributes') }}
                                        @endif
                                    </div>
                                </div>
                            @endif
