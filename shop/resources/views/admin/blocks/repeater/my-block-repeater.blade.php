...
<!-- inputs must have a "data-item-name" attribute ( it will be the key in json ) -->
<div class="row" >
    <div class="col-md-4">
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control" data-item-name="item-title" placeholder="Item title" value="{{ $item['item-title'] ?? '' }}" >
    </div>
    <div class="col-md-4">
        <label>Item text</label>
        <input type="text" class="form-control" data-item-name="item-text" placeholder="Item text" value="{{ $item['item-text'] ?? '' }}" >
    </div>
    <div class="col-md-12">
