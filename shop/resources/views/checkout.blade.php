                                    ...
                                    <div class="row row-gutter-12">
                                        <div class="col-lg-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingInputGrid" placeholder="{{ __('messages.name') }}" name="first_name" value="{{ old('first_name') }}" >
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingInput2Grid" placeholder="name" name="last_name" value="{{ old('last_name') }}">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-floating">
                                                <div class="form-group position-relative">
                                                    ...
                                                    <input type="tel" id="phoneInput" class="form-control phone-mask" placeholder="+38 (___) ___-__-__" name="phone"  value="{{ old('phone') }}" >
                                                    @if ($errors->has('phone'))
                                                        <div class="text-danger">
                                                            {{ $errors->first('phone') }}
                                                        </div>
